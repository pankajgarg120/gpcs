                    ...
                    <td width="733" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                <td height="30" class="pagehead">career Guidence Cell </td>
                              </tr>
                              <tr>
                                <td height="330" valign="top" class="content1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    <td><table width="700" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td align="center" class="welcome">A Career Guidenece cell is established under Vivekanand Career's Guidence Schem which conduct diffrent career guidence programm. for students is diffrent field under the guidence of expert career guidence counceller. </td>
                                        <td width="381"><img src="images/img13.jpg" width="381" height="297" /></td>
                                      </tr>
                                      <tr>
